...
```{r }
analysis_id <- "brain"
results_dir <- "/project2/guiming/xsun/proteome_alzheimer/16.brain_jansen_ukbb_joint_newscript/brain_output_fullgwas/"
...
```{r message=FALSE, warning=FALSE }
a <- locus_plot(region_tag="1_95", return_table=F,xlim=NULL,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,
...
```{r message=FALSE, warning=FALSE }
a <- locus_plot(region_tag="17_40", return_table=F,xlim=NULL,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,
...
```{r }
analysis_id <- "brain"
results_dir <- "/project2/guiming/xsun/proteome_alzheimer/16.brain_jansen_ukbb_joint_newscript/brain_output_subgwas/"
...
```{r message=FALSE, warning=FALSE }
a <- locus_plot(region_tag="2_76", return_table=F,xlim=NULL,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,
