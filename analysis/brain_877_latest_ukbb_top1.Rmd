---
title: "Results for GCST90012877_buildGRCh37 -- latest ctwas package (LD REF: UKBB, Weights: fusion, TOP1)"
author: "XSun"
date: "2023-06-28"
...
results_dir <- paste0("/project2/guiming/xsun/proteome_alzheimer/6.brain_wingo_latest_fusionwgts_ukbb_top1/brain_output/")
...
```{r message=FALSE, warning=FALSE }
a <- locus_plot(region_tag="1_81", return_table=T,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,
