...
```{r fig.height=10,fig.width=20}
outputdir <- "/project2/guiming/xsun/proteome_alzheimer/18.jansen_0202_fullgwas/output/AD_epjoint/"
outname <- "AD_ctwas"
gwas_n <- 472868
...
DT::datatable(data_merge,caption = htmltools::tags$caption( style = 'caption-side: left; text-align: left; color:black;  font-size:150% ;','genes with combined susie pip > 0.8 but were not reported by wingo et al'))
```
...
```{r fig.height=10,fig.width=20}
outputdir <- "/project2/guiming/xsun/proteome_alzheimer/18.jansen_0202_topremoved/output/AD_epjoint/"
outname <- "AD_ctwas"
gwas_n <- 472868
weight <- "wingo_722_brain_protein_lasso,wingo_888_brain_expr_lasso"
