---
title: "Results for Jansen et al  -- latest ctwas package (LD REF: 1000G, Weights: fusion)"
author: "XSun"
date: "2023-06-26"
...
results_dir <- paste0("/project2/guiming/xsun/proteome_alzheimer/7.brain_jansen_fusionwgts_1000g_lasso/brain_output/")
...
Earlier genes with pip > 0.8 are [here](https://xsun1229.github.io/proteome_alzheimer/brain_877_latest_ld1kg_fusion.html#Genes_with_high_pip)
...
wingo_gwas <- read.table("/project2/guiming/xsun/proteome_alzheimer/1.brain_wingo_latest_fusionwgts_1000g/brain_output/brain_ctwas.susieIrss.txt",header=T)
...
```{r message=FALSE, warning=FALSE }
a <- locus_plot(region_tag="20_33", return_table=T,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,
...
```{r message=FALSE, warning=FALSE }
a <- locus_plot(region_tag="15_30", return_table=T,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,
...
```{r message=FALSE, warning=FALSE }
a <- locus_plot(region_tag="11_37", return_table=T,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,
