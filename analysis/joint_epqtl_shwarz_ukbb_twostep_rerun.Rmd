---
title: "Joint analysis for brain eqtl and pqtl (2 step setting, fixed, GWAS:shwarz, LD:ukbb)"
author: "XSun"
date: "2023-10-04"
...
```{r }
analysis_id <- "brain"
results_dir <- "/project2/guiming/xsun/proteome_alzheimer/15.brain_schwarz_ukbb_joint_newscript_diff_settings/brain_output_preharmo_hzt_subgwas_2stepsrerun//"
...
```{r message=FALSE, warning=FALSE }
a <- locus_plot(region_tag="11_47", return_table=F,xlim=NULL,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,
...
```{r }
analysis_id <- "brain"
results_dir <- "/project2/guiming/xsun/proteome_alzheimer/15.brain_schwarz_ukbb_joint_newscript_diff_settings/brain_output_preharmo_hzt_fullgwas_2stepsrerun//"
